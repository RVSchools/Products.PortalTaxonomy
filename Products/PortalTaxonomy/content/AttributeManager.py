...
from Products.PortalTaxonomy import PROJECTNAME
...
registerType(AttributeManager, PROJECTNAME)
registerType(AttributeCollection, PROJECTNAME)
registerType(Attribute, PROJECTNAME)
